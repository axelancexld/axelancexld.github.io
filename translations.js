const T = {
    tr: {
        nav:    { about:"Hakkında", features:"Özellikler", download:"İndir", cta:"İndir", mods:"Modlar" },
        ...
        dl:     { tag:"İndir", h:"Oynamaya hazır mısın?", p:"CurseForge Launcher ile birkaç tıkta kur ve oynamaya başla.", ver:"Versiyon", sz:"Boyut", btn:"MellyCraft'ı İndir", stepsTitle:"Kurulum", s1:"CurseForge Launcher'ı indir ve kur", s2:"MellyCraft.zip dosyasını indir", s3:"CurseForge'da \"Import\" butonuna tıkla", s4:"Zip dosyasını seç ve bekle", s5:"Oynamaya başla!" },
        footer: { mc:"Minecraft, Mojang Studios'un markasıdır." }
    },
    en: {
        nav:    { about:"About", features:"Features", download:"Download", cta:"Download", mods:"Mods" },
